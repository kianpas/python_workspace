...
if st.button("조회"):
    ...
    exhibit_list = soup.find_all('div', class_='contest-title')
    # print(exhibit_list[0].find('a').text)
    #     print(exhibit_list[0].find('a')['href'])
    #     href = exhibit_list[0].find('a')['href']
    #     urlStr = 'https://www.thinkcontest.com/'+ href
    #     html = urllib.request.urlopen(urlStr)
    #     soup2 = BeautifulSoup(html, 'lxml')
    #     print(soup2.find('table', class_='type-5').text)
    
    for list in exhibit_list:
        print(list.find('a').text)
